...
func TestHostAllowed(t *testing.T) {
	...
	cases := []struct {
		...
		{"127.0.0.1:8080", true},
		{"[::1]:8080", true},
		{"192.0.2.50:8080", true}, // bare LAN IP — operator typed it
		{"203.0.113.5", true},
...
func TestCrossOriginGuard(t *testing.T) {
	...
	if rec := doReq(h, "POST", "192.0.2.5:8080", map[string]string{
		"Origin": "http://192.0.2.5:8080", "X-Hoptrail-CSRF": "1",
	}); rec.code != 200 {
